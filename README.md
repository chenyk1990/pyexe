...
**Pyexe* is a TEMPLATE python package. Any complex package can be built from this basic package. 
...
-----------
## Copyright
    The pyexe developing team, 2021-present
-----------
...
Using the latest version
    ...
    git clone https://github.com/chenyk1990/pyexe
    cd pyexe
    pip install -v -e .
or using Pypi
...
-----------
## Examples
    The "demo" directory contains all runable scripts to demonstrate different applications of pyexe. 

-----------
## Gallery
The gallery figures of the pyexepackage can be found at
    https://github.com/chenyk1990/gallery/tree/main/pyexe
